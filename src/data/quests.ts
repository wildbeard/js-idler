    ...
    steps: [
      {
        ...
        requirements: {
          items: [
            ...
            { item_id: 'tin_ore', value: 10, consumed: false },
          ],
        },
      },
      {
        ...
        requirements: {
          items: [{ item_id: 'bronze_bar', value: 10, consumed: true }],
        },
      },
    ],
  },
    ...
    steps: [
      {
        ...
        requirements: {
          items: [],
          autoers: [
            { upgrade_id: 'automine_copper', value: 0, consumed: false },
            { upgrade_id: 'automine_tin', value: 0, consumed: false },
          ],
        },
      },
    ],
