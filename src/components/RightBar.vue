...
const { s, availableAutoers, availableUpgrades, availableQuests } =
    ...
    <div>
      ...
      <ul class="available-autoers">
        ...
        >
          ...
          <template
            v-if="s.purchased_autoers.filter((a) => a.id === autoer.id).length"
          >
    ...
    <div>
      ...
      <ul class="available-quests">
        ...
        >
          <span
            :style="{
              color: questStore.canStartQuest(quest) ? 'black' : 'red',
            }"
          >
            {{ quest.name }}
          </span>
