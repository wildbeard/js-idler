...
export const upgrades: Upgrade[] = [
  {
    ...
    upgrades: [
      { level: 0, value: 0.1, cost: 200, requirements: { mining: 1 } },
      { level: 1, value: 0.15, cost: 350, requirements: { mining: 9 } },
      { level: 2, value: 0.25, cost: 450, requirements: { mining: 11 } },
      { level: 3, value: 0.75, cost: 750, requirements: { mining: 13 } },
      { level: 4, value: 1.0, cost: 1000, requirements: { mining: 15 } },
    ],
  },
  {
    ...
    category: 'mining_excess',
    upgrades: [
      { level: 0, cost: 200, value: 0.1, requirements: { mining: 8 } },
      { level: 1, value: 0.15, cost: 350, requirements: { mining: 9 } },
      { level: 2, value: 0.25, cost: 450, requirements: { mining: 11 } },
      { level: 3, value: 0.75, cost: 750, requirements: { mining: 13 } },
      { level: 4, value: 1.0, cost: 1000, requirements: { mining: 15 } },
  ...
  },
  {
    ...
    category: 'xp',
    upgrades: [
      { level: 0, cost: 1200, value: 0.1, requirements: { mining: 15 } },
      { level: 1, cost: 1650, value: 0.2, requirements: { mining: 30 } },
      { level: 2, cost: 2200, value: 0.3, requirements: { mining: 50 } },
      { level: 3, cost: 2450, value: 0.45, requirements: { mining: 60 } },
      { level: 4, cost: 2600, value: 0.6, requirements: { mining: 72 } },
    ],
  },
  {
